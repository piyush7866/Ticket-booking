...
contract EventContract {
    /*
    *This event will emit when ticket is successfully buyed
    */
    event buyticketSuccesuflly(address _from, uint256 _ticket); 

    /*
    *This event is triggred when Event is created successfully
    */
    event EventCreatedSuccessfully(address _from,string _name,uint256 _date,uint256 _price); 

    /*
    *This event is emitted whenthe user enters the event successfully.
    */
